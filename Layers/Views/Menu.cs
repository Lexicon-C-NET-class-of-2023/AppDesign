...
namespace Layers.Views
{
    public static class Menu
    {
        ...
        public static class Account
        {
            ...
            public static char ChooseWhichToModifyMenu(string[] alternatives) => GetUserInput("\n\n\nUpdate Account Options", alternatives);
            public static char ModifyMenu()
            {
                string[] alternatives = {
                "1. Modify Firstname",
                "2. Modify Lastname",
        ...
        public static class Lawnmover
        {
            ...
            public static int ChooseWhichToModifyMenu(string[] alternatives) => GetUserInputDblDigit("\n\n\nUpdate Lawnmover Options", alternatives);
            public static char ModifyMenu()
            {
                string[] alternatives = {
                "1. Modify Available",
